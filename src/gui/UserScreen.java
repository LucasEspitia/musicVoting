...
public class UserScreen extends Application {
    ...
    private void openUserInterface(Voter user) {
        ...
        remainingVotesLabel = new Label("Remaining Votes: " + user.getRemainingVotes());
    ...
    private void handleConfirmVote(Voter user) {
        ...
        updateRemainingVotesLabel(user.getRemainingVotes());   
    }
    /**
     ...
     */
    private void updateRemainingVotesLabel(int remainingVotes) {
        remainingVotesLabel.setText("Remaining Votes: " + remainingVotes);
    }
